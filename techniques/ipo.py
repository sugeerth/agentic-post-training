...
class IPO(BaseTechnique):
    ...
    priority = 3
    recommended_for = ["when DPO overfits", "regularized alignment", "research"]
    pros = ["Better regularization than DPO", "Theoretically grounded"]
    cons = ["Marginal gains in practice", "Less adopted"]
